...
$countProdutos = countProducts();
$countVendas = countSalesProducts();
?>
<!doctype html>
        ...
        <div class="container">
          ...
          <div class="row row-cards">
              ...
              <div class="card">
                <div class="card-body p-3 text-center">
                  ...
                  <div class="text-muted mb-4">
                    <div class="h1 m-0"><?php echo $countProdutos['count(1)'] ?></div>
            ...
            <div class="col-6 col-sm-4 col-lg-2">
              <div class="card">
                <div class="card-body p-3 text-center">
                  <div class="h1 m-0"><?php echo $countVendas['count(1)'] ?></div>
